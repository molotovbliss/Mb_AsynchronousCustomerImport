<?php
/*
 * A very small basic class to allow for pseudo threading/asynchornous requests via PHP to allow for
 * multiple spawning of any PHP script to leverage multiple CPU cores at once vs one core.
 * Original source: (now longer working)
 * http://www.php-code.net/2010/05/running-multiple-processes-in-php/
 * way back machine cache of above link
 * https://web.archive.org/web/20120419003742/http://www.php-code.net/2010/05/running-multiple-processes-in-php
 */
